	 ...
	 */
	 ...
	 public void createHealthPolicies() {
	  ...
	  public void createAutoPolicies() {	      
        ...
        AutoPolicy autoPolicy4 = new AutoPolicy("838383", "Chevy", "Trailblazer");
        AutoPolicy autoPolicy5 = new AutoPolicy("Rebecca", "12-3888347-ggg", 500.00, 12, "838383", "Chevy", "Trailblazer");
        ...
        policies.add(autoPolicy4);
        policies.add(autoPolicy5);
